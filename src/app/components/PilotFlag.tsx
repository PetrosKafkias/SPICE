export default function PilotFlag({ code, label }: { code: string; label?: string }) {
  if (code === 'GR') {
    return (
      <span className="relative block h-7 w-11 overflow-hidden rounded-md shadow-sm" role="img" aria-label={label || 'Greece'}>
  ...
  if (code === 'FI') {
    return (
      <span className="relative block h-7 w-11 overflow-hidden rounded-md bg-white shadow-sm" role="img" aria-label={label || 'Finland'}>
  ...
  if (code === 'PL') {
    return (
      <span className="block h-7 w-11 overflow-hidden rounded-md shadow-sm" role="img" aria-label={label || 'Poland'}>
  ...
  return (
    <span className="relative block h-7 w-11 overflow-hidden rounded-md shadow-sm" role="img" aria-label={label || 'Portugal'}>
