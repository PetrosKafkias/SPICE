...
export async function seedDatabase(db) {
  ...
  if (Number(db.prepare('SELECT COUNT(*) AS count FROM dashboard_data').get().count) === 0) {
    const dashboardRows = [
      ...
      ['citivoice', 'locations', [
        { id: 'central-plaza', name: 'Central plaza (eastern section)', description: 'Lack of shade and seating', count: 412, color: '#c0392b', x: 50, y: 46, topKeywords: ['Shade', 'Seating', 'Shelter', 'Trees'] },
        { id: 'northern-entrance', name: 'Northern pedestrian entrance', description: 'Safety at night - poor lighting', count: 234, color: '#f68b2c', x: 78, y: 22, topKeywords: ['Lighting', 'Safety', 'Night visibility', 'CCTV'] },
        { id: 'waterfront-promenade', name: 'Waterfront promenade', description: 'Damaged paving - accessibility issue', count: 198, color: '#2e6e45', x: 65, y: 57, topKeywords: ['Accessibility', 'Paving repair', 'Wheelchair access', 'Ramps'] },
        { id: 'play-area', name: "Children's play area", description: 'Outdated equipment', count: 187, color: '#637948', x: 22, y: 38, topKeywords: ['Play equipment', 'Safety surfacing', 'Shade', 'Toddler area'] },
      ]],
